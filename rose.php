	...
	if(isset($_POST['_komentarz']))
	{
		...
		else
		{
			...
			else
			{
				...
				$polaczenie->query("INSERT INTO komentarze VALUES (NULL, '$_login','$kom','6')");
	...
	<div id = "container" >
		...
		<div id = "content" >
			...
			<div id = "autor" >
				...
				<div id = "left" >
					<img src="img/rose.png" alt="" style="width: 100%; height: 100%;" /> 
				</div>
				
				<div id = "comment" >
				
					<div id = "upper"> 
						<text style="font-size:20px; font-weight: 700;">Rose</text> </br>
						Świeżutkie! </br>
						Tagi: #rose #flower #flowertatto 
					...
					<div id = "down" >
						...
						<div class = "k" >
							<?php
								...
								{
									$result = @$pol2->query("SELECT autor,tresc FROM komentarze WHERE id_wpisu = 6");
