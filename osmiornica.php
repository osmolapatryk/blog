	...
	if(isset($_POST['_komentarz']))
	{
		...
		else
		{
			...
			$_login=$_SESSION['login'];
				$polaczenie->query("INSERT INTO komentarze VALUES (NULL, '$_login','$kom','5')");
	...
	<div id = "container" >
		...
		<div id = "content" >
			...
			<div id = "autor" >
				...
				<div id = "left" >
					<img src="img/osmiornica.png" alt="" style="width: 100%; height: 100%;" /> 
				</div>
				
				<div id = "comment" >
				
					<div id = "upper"> 
						<text style="font-size:20px; font-weight: 700;">Octopus</text> </br>
						Jeszcze cieplutki! </br>
						Tagi: #octopus #kotwica #macki
					...
					<div id = "down" >
						...
						<div class = "k" >
							<?php
								...
								{
									$result = @$pol2->query("SELECT autor,tresc FROM komentarze WHERE id_wpisu = 5");
